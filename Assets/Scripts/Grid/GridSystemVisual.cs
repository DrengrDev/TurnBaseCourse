...
public class GridSystemVisual : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        //All grids visuals are shown at start, this prevents that from happening.
        UpdateGridVisual();
    }
    ...
    public void ShowGridPositionList(List<GridPosition> gridPositionList, GridVisualType gridVisualType)
    {
        ...
        {
            gridSystemVisSingleArray[gridPosition.x, gridPosition.z].
